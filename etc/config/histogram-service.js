...
*/
{
 mgmt_port:9127
, debug: true
, servers: [{server: "./servers/tcp", port:8127}]
, backends: ["./backends/console","./backends/repeater-regexp" ]
, repeater: [{ host: 'localhost', port: 8126, regexp:[".*website\\.page_generation\\.search.*", ".*website\\.page_generation\\.fileview.*"]} ]
